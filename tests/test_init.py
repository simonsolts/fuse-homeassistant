...
def test_const_exposes_new_config_keys_and_stat_templates() -> None:
    ...
    spec = importlib.util.spec_from_file_location(
        "fuse_const",
        Path("custom_components/fuse_energy/const.py"),
    )
    ...
    # statistic-id templates — must use ':' (external) not '.' (internal)
    ...
    # The placeholder value we ship — overwritten at runtime by the resolver.
